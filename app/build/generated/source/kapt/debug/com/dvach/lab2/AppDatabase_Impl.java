...
import com.dvach.lab2.models.UserDao;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Note` (`name` TEXT NOT NULL, `text` TEXT NOT NULL, `date` TEXT NOT NULL, `category` TEXT NOT NULL, `prioritet` TEXT NOT NULL, `check` INTEGER NOT NULL, `color` INTEGER NOT NULL, `id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `userName` TEXT, `email` TEXT, `password` TEXT, `userId` INTEGER NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Category` (`categoryName` TEXT NOT NULL, `userName` TEXT, `email` TEXT, `password` TEXT, `userId` INTEGER NOT NULL, PRIMARY KEY(`categoryName`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '9cc39c15f72bb2dc64c15094d1050802')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsNote.put("userName", new TableInfo.Column("userName", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsNote.put("email", new TableInfo.Column("email", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsNote.put("password", new TableInfo.Column("password", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsNote.put("userId", new TableInfo.Column("userId", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsCategory.put("email", new TableInfo.Column("email", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCategory.put("password", new TableInfo.Column("password", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "9cc39c15f72bb2dc64c15094d1050802", "b6b2d09eec1011a42171d2cbbafccf53");
